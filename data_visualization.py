...
#Getting the stock data : Deprecated
...
stock_data = yf.download('MSFT', start='2015-06-20', end='2020-06-20')
...
plt.plot(stock_data['Open'],color='magenta',linewidth=2, label="Open")
...
data = pd.read_csv("/content/thank_you.csv")

plt.figure(figsize=(16,8))

for c in set(data['ch']):
  df= data[data['ch']==c]
  plt.plot(df['x'],df['y'],linewidth=3)